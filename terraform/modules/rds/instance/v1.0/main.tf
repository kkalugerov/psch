...
resource "aws_db_instance" "this" {
  ...
  identifier               = format("%s-%s-%s", var.identifier, var.region, "rds")
  engine                   = var.engine
...
resource "aws_cloudwatch_log_group" "this" {
  for_each = toset([for log in var.enabled_cloudwatch_logs_exports : log if var.create_cloudwatch_log_group && !var.use_identifier_prefix])
