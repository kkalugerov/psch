...
|------|-------------|------|---------|:--------:|
| <a name="input_account_id"></a> [account\_id](#input\_account\_id) | AWS account in use | `string` | `""` | no |
...
| <a name="input_image_name"></a> [image\_name](#input\_image\_name) | ECR image name | `string` | `""` | no |
